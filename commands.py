...
class CmdsClass(Cog_Extension):
    ...
    async def helps(self, ctx):
        ...
        embed.add_field(name="", value="check network latency", inline=True)
        embed.add_field(name=">roll value1 value2", value="", inline=True)
        embed.add_field(name="", value="return random number\nfrom value1~value2\n(default is 1~30)", inline=True)
        embed.add_field(name=">meme", value="", inline=True)
        embed.add_field(name="", value="return random meme", inline=True)
        embed.add_field(name=">neko", value="", inline=True)
        embed.add_field(name="", value="return random neko picture", inline=True)
        embed.add_field(name=">vocaloid", value="", inline=True)
        embed.add_field(name="", value="return random vocaloid picture", inline=True)
        embed.add_field(name="randh", value="", inline=True)
        embed.add_field(name="", value="return random adult comic", inline=True)
